...
\hl{* Translated versions of the extended abstract are available in ten languages in the Supplementary Information: Arabic, French, German, Italian, Japanese, Korean, Portuguese, Spanish, Tamil, and Thai.}
...
HT was supported by the Engineering and Physical Sciences Research Council [EPSRC EP/V052128/1] during the preparation of this article and by The R Foundation for Statistical Computing for the organization of useR! 2021. HT is a board member of The R Foundation for Statistical Computing, serving on the R Foundation conference committee that arranges hosts for the useR! conference series and chairing Forwards, the R Foundation taskforce for women and under-represented groups. The R Foundation is currently funding YBS to support the useR! 2022 organization team. HT was administrator and volunteer for the R Project Google Season of Docs 2021 project, that funded work by AST (writer) and YBS (steering committee).
The organization of useR! 2021 was largely a volunteer effort, but stipends were available from the conference funds for specific roles. RJ, AST, SM, BA, NM, AU, and AE received code of conduct team stipends; AST, YBS, JPNG, MAC, RG, and JC received zoom host stipends; AST and MAC received stipends for their unrelenting efforts as diversity and social program leads, respectively. JR is funded by start-up award from Michigan State University; publication cost will waived due to PLoS-MSU partnership. 

\section*{Data availability}
For the purpose of open access, the authors have applied a Creative Commons Attribution (CC BY) license to any Author Accepted Manuscript version arising from this submission. The manuscript and the supporting docs are available at: https://github.com/rociojoo/Ten-simple-rules-inclusive-conference.

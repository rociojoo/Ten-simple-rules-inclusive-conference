...
%%JPNG am thinking of the metaphor of gears in a machine as a proxy for the process.  Think also about the inclusiveness of the different rules and how some facilitate others. The most encompassing rule is the number 10. This rule recognises the community learning process of DEI instead of being solely a practical and handy way of doing things. This should be the more comprehensive and inclusive level (gear) that include all others. Rules 1 and 2 are crucial because they represent two of the most important concepts we need to grasp: diversity and the requirements to express it freely. Rules 3 to 9 are the necessary practical pre-conditions that make the community learning process about DEI possible in the framework of a conference. I think that rules 1 and 2 can be represented by bigger toothed wheels than rules 3 to 9, but all need to fit and function together.The teeth of the toothed wheels would be representations of human forms representing the diverse teams involved.
\pdftooltip{
...
To make a more inclusive conference, it is necessary to identify which groups of people are being excluded, the barriers they may face to be part of the conference, and strategies to reduce them. 
...
Inclusion should start from the organizing team. Rule 3 refers to the importance of building an inclusive and diverse organizing team, and provides advice on work dynamics.
...
%ast: i dont know if adding something about the other side of the spectrum would work, something in the lines of "On the other hand, the non-transferability of abilities and experiences does not mean that people from privileged groups cannot work together to fight all forms of oppression. on the contrary," using power, co-liberation logic.
...
These rules concern diverse elements in the design of the conference. They are all important pieces for inclusion.
...
\label{rule_unbias}
%la: LA: repeating parts of my comment in Figure 1:maybe "mitigate bias" - unbiasedness is a reasonable goal once systemic biases are gone, in the meantime, introducing biases favoring marginalized folks is required to reach equity. Thus, while unbiasedness is the ultimate goal, the current rules should point to mitigate biases and that may require to bias in favor of marginalized groups. Equity and Justice call for biases in favor of marginalized folks. Unbiasing aims for equality that, in the current status quo, will keep favoring those who are already in the mainstream and will keep increasing marginalization for those currently in the margins. This is a great reference regarding the framework "mainstream/margins" https://www.trainingforchange.org/wp-content/uploads/2017/11/Mainstream-Margin-in-Groups.pdf See the cartoon about equality, equity, and justice here: https://onlinepublichealth.gwu.edu/resources/equity-vs-equality/ and here: https://www.reddit.com/r/coolguides/comments/o3ivsg/equality_equity_and_justice_explained_better/
...
Having a chance to present at a conference is an opportunity to gain--or keep--visibility in the community or field. %ast is something missing in this transition?
...
You can also reframe the awards ceremony \as{to acknowledge work beyond the traditional definition of merit/quality and include} those who contributed to community building, presented teaching materials, and assumed other care-taking roles.
...
%JPNG: I think in-person networking during a conference has a disadvantage in contrast to online and virtual interactions. In-person networking suffers from being contingent; they are meaningful only to the people that happen to be in the same place and at the precise time. If you weren't there during the coffee break, you lost the networking opportunity. On the contrary, written media like chats are recorded and stored, allowing you to join the conversation at every time while catching up on what has been said. This creates the opportunity for long term interactions during the conference, which is good for everyone and not only for people with some disadvantages (language) or different personality traits (introversion, shyness, etc.). I saw this kind of interaction not only during useR!2021 but also in other virtual conferences I had the opportunity to assist with. If you think this idea is relevant, we could add something like: "On the other hand, there is evidence that virtual communication before face-to-face interaction can make people from minoritized groups feel more included, thus participate more (e.g. [29, 30]). Written media like chats create opportunities for long term interactions and networking by allowing more people to join the conversation even when it has started some time ago."
...
For in-person conferences, the venue should comply with common accessibility standards, such as being adequate for people who use wheelchairs, have signs in Braille, and a sound system compatible with hearing devices and live interpretation, just to name a few important features. In addition to this, the organizers should take care proactively of invisible disabilities (e.g., dyslexia, anxiety, ADHD, autism and its spectrum). This could be done in many ways, for example, by providing quiet spaces for privacy and noise-free conversations, provide chairs in open spaces, and menus that menus that account for the dietary requirements participants need to respect.%ast: check the flow here
...
For instance, captions are helpful for non-native speakers, having the material available for download helps attendees with low bandwidth connection, etc. Accessibility efforts should be explicitly displayed in the official communication channels (see rule 8 about media strategy). 
...
Providing a welcoming and diverse environment by encouraging the full participation of non-native English speakers is critical (rule 2 about a welcoming environment for all). This may be done at different levels. First, by having spaces in languages other than English, both regarding the technical content of the conference and the social and networking aspects. These exclusive spaces have the benefit of not requiring technical adjustments, but have the problem of not communicating outside their specific public.   
Second, for presentations spoken in English, identify some other key languages for the conference and provide at least English-to-English captions (see rule 6 about accessibility for disabilities), but also translated captions or live interpretation into these key languages. Allow for multilingual Q \& A sessions with an interpreter. Third, include workshops, presentations, and events in languages other than English in the schedule, and provide captions or live interpretation to English. 
...
to emphasize that everybody is welcome in this event. This could be done through publishing a diversity statement (e.g., https://user2021.r-project.org/about/diversitystatement/), the Code of Conduct, the accessibility guidelines, and advertising financial support (see rule 9 about financial resources). Try to come up with creative ways to show that everyone is seen, respected, and welcome. \la{For example, useR! 2021 created "Margot, the marmot" a mascot for the conference. Margot is a cartoon with different designs reflecting folks that the conference wanted to reach. In particular, Margot wears different scarfs. The scarfs include colors of flags from different communities in R such as MiR´s, Rainbow R, ..., etc. (Figure 2)."}.
Also, try to advertise the conference in multiple languages (see rule 7 about language) and multiple platforms (e.g. Twitter, Facebook, LinkedIn, conference website, mailing lists)--
part of your community may use a different platform than the ones adopted by people who regularly attend the conference. 
% rj: allude to the diverse organizing team - to tap into groups, contexts and make choices on platforms and ways to communicate
...
Make the effort to teach yourself the vocabulary %rita A reference to this vocabulary could be add on the conference main page? or in the code of conduct? %ast- good idea, we can point to resources here like the reference i added before: https://www2.le.ac.uk/projects/oer/oers/ssds/oers/study-skills/studyskills.pdf the main aspect of the "teach yourself" part is that you don't ask people to teach you but go for it, but giving some links is nice.
...
Conferences usually ask for cover letters or applications to assign these grants, and this can be a time-consuming, emotionally-demanding task. Simplify as much as you can the process of asking for financial support %rita Could you give a concrete example? ast - yes! ö
People who do not have the time (e.g., because they have care-taking roles) might decide not to apply if the process is overtly complicated. \la{Bear in mind that transferring money internationally is a cumbersome administrative process that can significantly augment the burden of already marginalized groups. Whenever possible, facilitate ways around money transfer (e.g., book flights, hotel reservations, waive conference fees).}
...
A conference can make a difference in the path towards inclusion. The organizers of a conference edition and selection committees should do their best to pass their knowledge on best practices and problems encountered to the next organizers.
...
Make the conference part of a long-term process for inclusion. Do not expect the conference to encompass all the dimensions of diversity at once.
Conceiving diversity and inclusion as a step-by-step process through successive conference versions can increase success and reduce unintended discrimination in the long run.
...
After the conference is over, assess whether equity and inclusion goals were met during the meeting. Ask for feedback about the conference by posting a survey during and after the conference to let attendees evaluate whether the inclusion goals of the conference were met. 
When designing feedback surveys, ask for different information that would let you know about the demographic composition of the attendees to the conference. 
Remember that some of this information varies greatly from region to region and adapt your options to the local or regional context. When choosing categories, avoid letting people in minoritized categories fall in the "other" option. You can also try to make open answer options to let people self-identify and express their opinions freely. Let all responses be optional and anonymous, but encourage your attendance to answer and commit to data privacy. 
...
% Pass
Importantly, make sure to share the information with future organizers so that they can use it as a starting point and keep working to improve inclusion in the next editions of the conference. If you are part of a stable meetings committee, encourage organizers to follow these rules and help set up new standards for inclusion. Share also your new and extended network and nominate people for future leadership. A good way to do this is documenting your processes, lessons, and guides in blog posts, reports and presentations. They may be useful not only for your conference series but for other communities that are having the same questions that you are.
...
%responbile communication (not here, see laura's comment) Be explicit about the biases you are tackling and acknowledge which audiences your conference is not doing enough to include.

...
\linelabel{info}\hl{The organizers will likely be able} to evaluate the outcomes associated with these goals directly from the information collected from the organizing team, speakers, and participants (e.g.\ \hl{city/state/country of origin} or preferred language).

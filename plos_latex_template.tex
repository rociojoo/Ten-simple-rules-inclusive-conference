...
Think about the reasons why you want to create a more diverse conference and try not to treat diversity as a checklist, avoid using diversity and inclusion work for image purposes, and do not act as a benefactor or savior but as a genuine collaborator.
...
Actively be an ally: if you understand your own privileges (unearned advantages given by society to some people but not all) \cite{}, you can help to work on end oppression in your conference.

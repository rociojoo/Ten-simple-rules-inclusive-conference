...
However, they are likely to reproduce the systematic discrimination occurring in other spaces in our fields and become [bad experiences]. 
...
We have organized these rules in three groups, because they refer to the foundations (Rule 1 and 2), the actions regarding people (Rules 3 to 5), the actions regarding conference design (Rules 6 to 9), and a general synthesis %ast this is an attempt, but i am not a fan of rule 10 alone at the end. actually the whole classification when written seems off to me (right now, this might change)
...
Offering scholarships or grants to attend the conference is a common way to boost participation from different groups, and some conferences ask for cover letters or applications to them. These applications may be counterproductive, if they attract people that do not need the money but apply to enrich their CVs, and can filter out people who do not feel entitled to earn them.  
Applying for loans, grants, and scholarships may be an emotionally demanding task. Do not complicate the attendees' lives by asking for long essays to convince a committee that they deserve your support. For this stage of the process, a certain degree of trust goes a long way-- when someone says they need the support, it is best to give them the waiver rather than second guess their eligibility. If the applicants for fee waivers are numerous and your budget cannot allow for that many fee waivers, you could ask for a short application.

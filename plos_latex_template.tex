...
%ast ¿algo más enfático? [do the effort to] teach yourself the correct choice of words...
social media publications and your website, to be respectful of every culture and situation;
%ast yo cortaría esto en dos separadas. 
...
% ast: don't forget people in vulnerable job positions, such as post-docs
...
%ast Bear in mind that most accessibility practices are beneficial to everyone. Captions, for instance, are used by non-native speakers and people that access the conference in loud environments. The prior availability of material benefits people with low bandwidth and non-native speakers as well.

\section*{Rule 7: Put more effort in promoting your conference among groups of people who are usually underrepresented}

If some minorities are under represented in your conference, they may not feel part of the community or may not have the financial resources to attend. Promote the conference in both ways: as welcoming for everyone and supportive for those who do not have the money %ast: or "the credentials" to be there.
...
%the code of condcut should be displayed proeminently in several spaces of the conference and it should be effective if it deters people from unaccepted behavior in the first place

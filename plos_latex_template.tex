...
% % Batool: I didn't change anything in the abstract - you can check the history - I copied the abstract and pasted, then the colour change for the abstract but it contains all text and suggestions/edits by Janani - my apologies (didn't commit the changes).  
...
\emoji{bulb} \textbf{Practical tips:} As a starting point, the meeting organizers could identify which groups warrant deliberate efforts to ensure fair inclusion, and determine the contributing factors (\textit{e.g.}, explicit discrimination, participation fees, etc.).
...
The organizers should promote a supportive and respectful environment, where all attendants can be themselves without fear of rejection or isolation. This includes promoting the idea that anyone can act in defense of other attendants in case anything unpleasant, incorrect, of offensive happens. Instead of looking away, act as "active bystanders" and intervene to keep the community safe.
[ast: should we add pre-conference allyship workshops? i saw a conference that had one pre-conference events for the whole community, just brilliant]
...
\emoji{bulb} \textbf{Practical tips:} If you have already started assembling an organizing team, check for gaps in its composition and find representatives accordingly. 

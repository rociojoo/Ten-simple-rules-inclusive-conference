...
% Rocío: Could add a line introducing Fig. in https://docs.google.com/drawings/d/1iS1pLc9OldLMe_jhNT6OGIbT9s5KvlHpUoDd19vHkCY/edit?usp=sharing and the whole structure
...
%i rephrased slightly, avoiding "support" it's not a question of privileged people giving support but of positions being given importance
...
When organizing an international academic conference, you may reach local associations, student organizations, or other Early Career Researchers groups or communities of practice: ask for their barriers for participation, and explicitly invite them to contribute to the conference. % Rocío: ask about their requirements and barriers sounds a bit confusing.
...
However, social events in in-person conferences can be exclusive (e.g. galas or dinner nights at expensive venues), and they are a common place for code of conduct violations to occur \cite{auroraHowRespondCode2019}. % Rocío: any reference to back the last statement? The CoC guide? ast: yes
...
Needless to say, an inclusive online component of a hybrid conference is not a free pass to have an exclusionary in-person component. % Rocío: I know this is a bit aggressive so I wouldn't mind if anybody helps with the wording. 
% Liz: I like it, but you could say
% an inclusive online component doesn't eliminate the need to organize an inclusive in-person component.
...
% Liz: I don't think it's actually ironic. maybe surprising or counterintuitive? ast: absolutely! i put importantly at the end to highlight that without opposition

If the conference is in person, the venue must be accessible for people with mobility limitations. 
% Liz: let's stay away from deficit-model language like "limitations." Possible aternatives:
% people who use wheelchairs or other assistive mobility devices
% ... must be physically accessible for disabled people


Accommodations such as a quiet space for neurodivergent people should also be provided.
% Liz: I hate "accommodateions because it sounds like something optional or for comfort or luxurious Consider something like "facilities"?
...
% Liz: avoid using disabilities as nouns like -- "the blind", "the deaf" etc. I woul duse "people who are deaf or hard-of-hearing" above. There's controversy about whether the word person
% should come first ("person who is blind") or the identity should come first ("blind person:) but the person should always be acknowledged (like "participants with disabilities", blind scientist", etc.. It's kind of objectifying without a person-related word.
...
% Liz: not just alt-text, the whole site should be screen-reader accessible so:
% communication about the conference should be fully screen-reader accessible including alt-text, and any videos should have both captions and sound.
...
% Liz: It is essential to provide an accessible version of the slides for people who won't be seeing them One of the most important assumptions about presentations are that they will be both seen and heard. Usually, neither of these channels is a complete source of information about the presentation. For example, when discussing computer programming, code is usually displayed on slides while the presenter talks about them. They seldom read the details of what appears on the slides in enough detail for a blind person to learn, and a deaf person will also miss some explanation. Presenters  should provide as much information as possible on both channels, but in order to compensate for the fact that this is not common practice, blind people need to be able to read an accessible version of the slides at the same time they listen to the presentation. It is critical to make these materials available before the conference starts..
...
% Liz: "for people who use whellchairs" rather than "for wheelchairs"
...
% Liz: maybe strengthen the last phrase to use their expertise to solve accessibility problems and collaborate on decisions about accessibility practices.

% Liz: As design justice author Sasha Costanza-Chock and the Design Justice League say, "center the voices of those who are directly impacted by the outcomes of the design process".  %Rocío: maybe slightly rephrase the last sentence since it seems to imply that everybody knows Sasha Costanza-Chock.
% not sure if that's a good characterization-- I am just learning about her right now.
...
% The linguistic diversity of conference participants is often overlooked,
% resulting in missed opportunities for them, as well as for the conference
...
% Rocío: Pasting Batool's text in her 10 simple rules because there are very valuable things we could use: "Rule: Meeting the need of linguistically diverse audience. Most international conferences are held in English. However, English is only spoken by 4.83 percent of the world population. If the panelist or speakers will not be presenting in their native language, it may helpful to rephrase audience questions in a less complex language. Consider letting speakers know in advance that they can ask for a question to be translated to them in their native language and that they can respond in their native language.    If possible, ensure that some sessions are delivered by languages other than English"
...
% Rocío: pasting this part of the text here because it may go under Andrea's idea for communication: "Nevertheless, having a diverse offer of networking opportunities that can appeal to people with different backgrounds, accessibility needs, and preferences can be challenging, especially if you have the mindset of organizing each activity for the complete pool of attendants. If you think of smaller activities that can reach specific groups, preferably co-lead by community leaders, these sessions can be more productive and successful, and even inclusive, than trying to organize one single activity that can please the whole community. Some examples are the newbies sessions for first-timers, mixers lead by specific subgroups or communities, or leisure activities that reunite subgroups with the same interests: arts, exercise, sports, movies, etc."

%sara: this fits better in the communication rule
...
% If the goal is to help the people who really need it, the language needs to make that clear without shrouding it with fancy-sounding phrases or terms that single out the recipients (e.g. `grant recipient' or `diversity scholar', respectively). Do not call it a scholarship or a grant. Ultimately, it is a fee waiver or a discount for the people who need additional financial support. 
% Rocío: I removed the part of naming the scholarship/grant/waiver, because if it goes somewhere it should be communication. Andrea, Batool, please see if it fits there.
